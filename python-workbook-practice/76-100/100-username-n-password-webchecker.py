# Create a webapp with Flask; Let users submut isername and password;
# checks if the username exists and if the password satisfies 3 conditions as in exercise 81
